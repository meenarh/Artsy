...
import mobile1 from "../assets/images/homepage/mobile2.png";
import mobile2 from "../assets/images/homepage/mobile1.png";
import mobile3 from "../assets/images/homepage/mobile3.png";
      ...
      <div className="font-serif">
        ...
        <div className="home">
          ...
          <div className="image-box">
            ...
            {/* Desktop view images ends */}

            {/* Mobile view images */}
            <div className="images md:hidden justify-center relative left-[86px] pb-[180px]">
              <img
                src={mobile3}
                alt="smiling girl"
                className="absolute"
              ...
              <img
                ...
                alt="red flowers"
                className="absolute"
                style={{width: "200", height: "200", transform: 'rotate(15deg)'}}
              />
              <img
                src={mobile1}
        ...
        {/* Features */}
        <div className="features mt-8 pt-10">
          <h4 className="text-black text-4xl font-bold p-8">Featured Products</h4>
          <hr
            className="p-6"
            style={{
              width: "85%",
          ...
          <div className="flex-row p-6">
            <div className="feature1 flex pb-8">
              ...
              <div className="flex-row">
                <h4 className="text-black text-3xl p-6">
                ...
                <p className="text-black text-xl p-6">
                  ...
                  vehicula ut id elit. Donec sed odio dui. Donec ullamcorper
            ...
            <div className="flex">
              ...
              <div className="">
                <ul className="list-item text-3xl">
                  ...
                  <li className="flex-row">
                    <MdOutlineLocationOn /> Lagos,Nigeria
                  </li>
                </ul>
              </div>
            </div>
        ...
        <p className="copyright text-2xl text-gray text-center font-semibold opacity-50">
